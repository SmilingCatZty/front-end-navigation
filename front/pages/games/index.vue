<template>
  <div class="games">
    <div class="games-box">
      ...
      <div v-if="editable" class="box-add" @click="addGame()">
        <svg
          t="1689660697883"
          class="icon"
  ...
  <Dialog :showGameDialog="showGameDialog" @closeDialog="closeDialog" @update="update" />
</template>
...
const showGameDialog = ref<boolean>(false) // 展示添加游戏弹窗
